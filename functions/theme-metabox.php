...
function icy_metabox_posts(){
	...
	$meta_box = array(
		'id' => 'icy-metabox-page-message',
		'title' =>  __('Page Settings', 'framework'),
		'description' => __('Set a title, a description and upload an image for the page. Images must be 1920px by any height.', 'framework'),
		'page' => 'page',
		'context' => 'normal',
		'priority' => 'high',
		'fields' => array(
    		array(
    				...
    				'desc' => __('Type in the desired page title.', 'framework'),
    				'id' => 'icy_page_title',
    				'type' => 'text',    				
    			),
				array(
    				'name' =>  __('Page Subtitle', 'framework'),
    				'desc' => __('Type in the desired page subtitle.', 'framework'),
